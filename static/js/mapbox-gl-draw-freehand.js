require = (function() {
 ...
 6: [function(require, module, exports) {
  ...
  "../constants": 1,
  "../lib/common_selectors": 2,
  "../lib/create_vertex": 3,
  "../lib/double_click_zoom": 4,
  "../lib/is_event_at_coordinates": 5
 }],
 7: [function(require, module, exports) {
  ...
  function cleanCoords(geojson, options) {
   ...
   if (geojson.coordinates) {
    ...
    return helpers.feature({
     type: type,
     coordinates: newCoords
    }, geojson.properties, geojson.bbox, geojson.id);
   }
  }
 ...
 "@mapbox/mapbox-gl-draw-freehand-mode": [function(require, module, exports) {
  ...
  FreeDraw.onSetup = function() {
   ...
   this.updateUIClasses({
    mouse: _constants2.default.cursors.ADD
   });
  ...
  FreeDraw.onMouseUp = function(state, e) {
   if (state.dragMoving) {
    ...
    this.fireUpdate();
    this.changeMode(_constants2.default.modes.SIMPLE_SELECT, {
     featureIds: [state.polygon.id]
    });
   }
  };
  ...
  "../src/lib/drag_pan": 16,
  "@mapbox/mapbox-gl-draw/src/constants": 1,
  "@mapbox/mapbox-gl-draw/src/lib/double_click_zoom": 4,
  "@mapbox/mapbox-gl-draw/src/modes/draw_polygon": 6,
  "@turf/simplify": 14
 }]
}, {}, ["@mapbox/mapbox-gl-draw-freehand-mode"]);