...
from sequence.models import Sequence, Image, MapFeature
...
urlpatterns = [
    ...
    re_path(r'^(?P<version>(v1))/map-feature.mvt', mvt_view_factory(model_class=MapFeature, geom_col='geometry_point'),
            name="api.sequence.map_feature_mvt"),
