	...
	*/
	...
	function initViewer(){
		...
		viewer.on(Mapillary.Viewer.nodechanged, function(node) {
			...
			street_level_poi_map.panTo(node_latlon);
	...
	function moveToCenter(){
		const center = street_level_poi_map.getCenter();
	...
	*/
	...
	function showRouteOnMap(geojsonFeature, name){
		...
		map_route = L.geoJSON(geojsonFeature).addTo(street_level_poi_map);
	...
	*/
	...
	function toggleMapSize(){
		...
		street_level_poi_map.invalidateSize();
